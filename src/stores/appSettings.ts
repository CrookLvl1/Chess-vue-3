...
export const useAppSettings = defineStore('app-settings', () => {
    ...
    const languages: Record<LanguageId, LanguageStrings> = {
        ru: {
            ...
            serverOffline: 'Идёт подключение, пожалуйста подождите...',
            serverError: 'Произошла ошибка, попробуйте перезагрузить страницу',
            stalemate: 'Пат',
            send: 'Отправить',
            ...
            link: 'ссылка',
            about: 'Начинающий front-end web разработчик, все технологии изучил самостоятельно в течение ~8 месяцев. Не имею коммерческого опыта разработки веб-приложений, однако имеется небольшой собственный pet-проект. Имеется небольшой некоммерческий опыт работы с вебсокетами и REST запросами.',
        ...
        eng: {
            ...
            whiteWin: `White won`,
            blackWin: `Black won`,
            serverOffline: 'Connecting, please wait...',
            serverOnline: 'Server connected!',
            serverError: `Failed to connect to server, try to reload the page`,
            checkmate: 'Checkmate',
            draw: 'Draw',
            returnButton: 'Return',
            play: 'Play',
